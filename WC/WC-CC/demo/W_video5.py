...
video3 = cv2.VideoCapture("/home/lukelin/Desktop/WC-CC/demo/WCC.mp4")
...
input_1 = '/home/lukelin/Desktop/result/output/WGCL_CCtt.txt'
...
for i in range(len(x)):
	...
	if i%ratio==0:
		...
		cv2.namedWindow("[WGCL] Control Command", cv2.WINDOW_NORMAL)
		cv2.imshow("[WGCL] Control Command", frame2)
		cv2.moveWindow("[WGCL] Control Command",650,1)
		cv2.resizeWindow("[WGCL] Control Command",600,300)
		
		cv2.namedWindow("[WGCL] Transmission Time", cv2.WINDOW_NORMAL)
		cv2.imshow("[WGCL] Transmission Time", frame3)
		cv2.moveWindow("[WGCL] Transmission Time",1250,1)
...
if float(error_count/i) < 0.001:
	cv2.imshow("[WGCL] Control Command", fine)
else:
	cv2.imshow("[WGCL] Control Command", bad)
cv2.moveWindow("[WGCL] Control Command",650,1)
cv2.resizeWindow("[WGCL] Control Command",600,300)
cv2.waitKey(0)			
