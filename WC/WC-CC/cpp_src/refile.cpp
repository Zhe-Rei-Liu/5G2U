...
int main ()
{
	...
	ifstream inf;
	inf.open("exetime_recording/ts_exetime_client.txt");
	ofstream outf1;
	outf1.open("../../recording/ts_2-1_CCclient.txt");
	ofstream outf2;
	outf2.open("../../recording/ts_3-2_CCclient.txt");
	ofstream outf3;
	outf3.open("../../recording/ts_11-10_CCclient.txt");
	ofstream outf4;
	outf4.open("../../recording/ts_12-11_CCclient.txt");
	ofstream outf5;
	outf5.open("../../recording/WCCC_exe.txt");
	...
	{	
		...
		if(s[0]=='3')			
		{
			...
			outf5<<fixed<<setprecision(9)<<vdiff_2+vdiff_1<<'\n';
		}
