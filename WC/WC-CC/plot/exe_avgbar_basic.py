...
print("=======Control Command=======\n"+chr(916)+"ts_2-1=", height1[0],'\n'+chr(916)+"ts_3-2=", height2[0],'\n'+chr(916)+"ts_5-4=", height3[0],'\n'+chr(916)+"ts_6-5=", height4[0],'\n'+chr(916)+"ts_8-7=", height5[0],'\n'+chr(916)+"ts_9-8=", height6[0],'\n'+chr(916)+"ts_11-10=", height7[0],'\n'+chr(916)+"ts_12-11=", height8[0])
print("=======    Alarming   =======\n"+chr(916)+"ts_2-1=", height1[1],'\n'+chr(916)+"ts_3-2=", height2[1],'\n'+chr(916)+"ts_5-4=", height3[1],'\n'+chr(916)+"ts_6-5=", height4[1],'\n'+chr(916)+"ts_8-7=", height5[1],'\n'+chr(916)+"ts_9-8=", height6[1],'\n'+chr(916)+"ts_11-10=", height7[1],'\n'+chr(916)+"ts_12-11=", height8[1])
print("=======   Monitoring  =======\n"+chr(916)+"pts_2-1=", height1[2],'\n'+chr(916)+"pts_3-2=", height2[2],'\n'+chr(916)+"pts_5-4=", height3[2],'\n'+chr(916)+"pts_6-5=", height4[2])
print("=============================\n")	
...
plt.legend((bar1[0], bar2[0], bar3[0], bar4[0], bar5[0], bar6[0], bar7[0], bar8[0]), (r'$\Delta$ts_2-1 \ $\Delta$pts_2-1', r'$\Delta$ts_3-2 \ $\Delta$pts_3-2', r'$\Delta$ts_5-4 \ $\Delta$pts_5-4', r'$\Delta$ts_6-5 \ $\Delta$pts_6-5', r'$\Delta$ts_8-7',r'$\Delta$ts_9-8',r'$\Delta$ts_11-10',r'$\Delta$ts_12-11'))

createtotalLabels(labels,1.3)
