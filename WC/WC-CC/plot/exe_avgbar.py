...
file = '/home/lukelin/Desktop/recording/ts_6-5_CCserver.txt' 
ccx65,ccy65 = [],[]
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
...
file = '/home/lukelin/Desktop/recording/ts_6-5_Aserver.txt' 
ax65,ay65 = [],[]
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
...
xaxis_val = ['Control Command', 'Warning', 'S.D Uploading']
