...
int main ()
{
	...
	ofstream outf1;
	outf1.open("../../recording/ts_2-1_Aclient.txt");
	ofstream outf2;
	outf2.open("../../recording/ts_3-2_Aclient.txt");
	ofstream outf3;
	outf3.open("../../recording/ts_11-10_Aclient.txt");
	ofstream outf4;
	outf4.open("../../recording/ts_12-11_Aclient.txt");\
	ofstream outf5;
	outf5.open("../../recording/WCA_exe.txt");
