...
file = '/home/lukelin/Desktop/result/output/LCP_CCWT_2.txt' 
W_ccwt_2 = []
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
...
file = '/home/lukelin/Desktop/result/output/LCP_AWT_2.txt' 
W_awt_2 = []
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
...
p2 = plt.plot(x, W_ccwt_2,linestyle = '-',color = 'red' ,label = 'LCP')
...
p2 = plt.plot(x, W_awt_2,linestyle = '-',color = 'red' ,label = 'LCP')
x_major_locator = MultipleLocator(5)
ax = plt.gca()
ax.xaxis.set_major_locator(x_major_locator)
plt.xlim(0,90.5)
