...
file = '/home/lukelin/Desktop/result/output/WGCL_CCWT_1.txt' 
W_ccwt_1 = []
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
...
file = '/home/lukelin/Desktop/result/output/WGCL_AWT_1.txt' 
W_awt_1 = []
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
...
file = '/home/lukelin/Desktop/result/output/WGCL_MWT.txt' 
W_mwt = []
with open(file,'r') as f:
	lines = f.readlines()
	for line in lines:
		...
		mnumber = mnumber +1
print("\nPercentage of Bandwidth Distributed by WGCL:")
...
p2 = plt.plot(x, W_ccwt_1,linestyle = '-',color = 'red' ,label = 'WGCL')
...
plt.text(91, 0.5 , 'WGCL: %0.3f%%'%(cctotalWT_2/90500.0*100.0),fontsize=10)
...
p2 = plt.plot(x, W_awt_1,linestyle = '-',color = 'red' ,label = 'WGCL')
x_major_locator = MultipleLocator(5)
ax = plt.gca()
ax.xaxis.set_major_locator(x_major_locator)
plt.xlim(0,91)
...
plt.text(91, 0.5 , 'WGCL: %0.3f%%'%(atotalWT_2/90500.0*100.0),fontsize=10)
plt.text(91, 0.4 , '----------------------------',fontsize=10)
plt.legend(bbox_to_anchor=(1.09, 1.05),fontsize=9)

plt.subplot(3,1,3)
p1 = plt.plot(x, AW_mwt,linestyle = '-',color = 'blue' ,label = 'AW-WGCL')
p2 = plt.plot(x, W_mwt,linestyle = '-',color = 'red' ,label = 'WGCL')
x_major_locator = MultipleLocator(5)
ax = plt.gca()
ax.xaxis.set_major_locator(x_major_locator)
plt.xlim(0,91)
...
plt.text(91, 0.5 , 'WGCL: %0.3f%%'%(mtotalWT_2/90500.0*100.0),fontsize=10)
plt.text(91, 0.4 , '----------------------------',fontsize=10)
plt.legend(bbox_to_anchor=(1.09, 1.05),fontsize=9)
