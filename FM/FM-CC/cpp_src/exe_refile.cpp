...
int main ()
{
	...
	ifstream inf;
	inf.open("/home/j/Desktop/FM-CC/bin/exetime_recording/ts_exetime_server.txt");
	ofstream outf1;
	outf1.open("/home/j/Desktop/recording/ts_5-4_CCserver.txt");
	ofstream outf2;
	outf2.open("/home/j/Desktop/recording/ts_7-5_CCserver.txt");  //忽略多線程的時間
	ofstream outf3;
	outf3.open("/home/j/Desktop/recording/ts_8-7_CCserver.txt");
	ofstream outf4;
	outf4.open("/home/j/Desktop/recording/ts_9-8_CCserver.txt");
	ofstream outf5;
	outf5.open("/home/j/Desktop/recording/FMCC_exe.txt");
	...
	{	
		...
		if(s[0]=='9')			
		{
			...
			outf5<<fixed<<setprecision(9)<<vdiff_4+vdiff_3+vdiff_2+vdiff_1 <<'\n';
