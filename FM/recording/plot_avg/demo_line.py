...
plt.text(1400, .0185, r'$\mu=%0.9f$'%(ccmean)+'   $\sigma=%0.9f$'%(ccst_dev)+'    Max=%0.9f'%(ccmax))
...
#bar1 = plt.bar(x, y, color='blue')
plt.text(1400, .0185, r'$\mu=%0.9f$'%(amean)+'   $\sigma=%0.9f$'%(ast_dev)+'    Max=%0.9f'%(amax))
...
#bar1 = plt.bar(x, y, color='blue')
plt.text(1400, .0185, r'$\mu=%0.9f$'%(mmean)+'   $\sigma=%0.9f$'%(mst_dev)+'    Max=%0.9f'%(mmax))
